...
* Any change to the `src/main/webapp` implies a copy of the file in the exploded deployment.
* Any change to the `src/main/webapp/WEB-INF` implies a copy of the file in the exploded deployment and a redeploy.
