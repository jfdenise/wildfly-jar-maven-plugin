...
class AbstractBuildBootableJarMojo extends AbstractMojo {
    ...
    protected String retrievePluginVersion() throws UnsupportedEncodingException, PlexusConfigurationException, MojoExecutionException {
    ...
    protected Path resolveArtifact(String groupId, String artifactId, String version) throws UnsupportedEncodingException,
