 ...
 * @author jdenise
 */
public class IncludedDefaultConfigurationCloudTestCase extends BootableJarMojoTest {

    public IncludedDefaultConfigurationCloudTestCase() {
        super("test20-pom.xml", true, null);
    }
